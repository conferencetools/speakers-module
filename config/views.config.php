...
return [
    'speakers/layout' => $viewDir . 'layout.phtml',
    'speakers/dashboard/index' => $viewDir . 'dashboard/index.phtml',
    ...
    'speakers/admin/hotel/index' => $viewDir . 'admin/hotel/index.phtml',
    'email/speaker-invite' => $viewDir . 'email/invite.phtml',
];